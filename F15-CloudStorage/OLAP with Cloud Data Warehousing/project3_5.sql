...
and lineorder_opt.query=11
and dwdate_opt.query=1
and d_year=1997 
and lo_discount between 1 and 3 
and lo_quantity < 24;
-- end query1_opt
...
-- start query2_opt
select sum(lo_revenue), d_year, p_brand1 from lineorder_opt, dwdate, part_opt, supplier_opt
where lineorder_opt.query=5
and part_opt.query=2 
and supplier_opt.query=2 
...
where lineorder_opt.query=333
and customer_opt.query=3
...
CREATE EXTERNAL TABLE word ( word STRING, count INT)
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
LOCATION 's3://zhangyuchengproject4/smallout/';
