...
public class Simulation1 {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new Simulation1().createAndShowSimulation();
			}
		});
	}
	...
	public void createAndShowSimulation() {
		...
		final int wheelChair = 10; // how many people in wheelChair when there is
									// 10 people
		final int payInCash = 0; // how many people pay with cash when there is
									// 10 people
		final int luggage = 0; // how many people has one luggage when there is
								// 10 people
		final int groupPeople = 0; // how many group people to create when
									// create 10 people

		// parameter for different kinds of buses
		final int doubleSizeRate = 0; // how many bus has double size in 10
										// buses.
		final int threeDoorsRate = 0;// how many bus has 3 doors in 10 buses.
