...
public class Simulation3 {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new Simulation3().createAndShowSimulation();
			}
		});
	}
	...
	public void createAndShowSimulation() {
		...
		final int betterEngineRate = 10; // how many bus has better engine that
		...
		boolean wait = false; // if the driver ahead of schedule, wait until the
